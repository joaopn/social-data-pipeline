"""MCP server configuration for Social Data Bridge.
...
def main():
    print()
    print("  Social Data Bridge - MCP Server Configuration")
    print("  ===============================================")
    print()
    ...
    if not db_setup or not db_setup.get("databases"):
        print("  Error: No databases configured. Run first: python sdb.py db setup")
        sys.exit(1)
